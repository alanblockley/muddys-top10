# Radio Reads Generator

## Objective
Create broadcast-ready scripts for the weekly chart show.
...
## Output
Intro, Top 10 intro, Top 5 recap, Top 3 recap, outro and optional position reads.
